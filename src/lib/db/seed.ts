...
const CATEGORIES: { id: string; parentId: string | null; name: string; description: string }[] = [
  ...
  { id: "quant-ph", parentId: null, name: "Quantum Physics", description: "Quantum mechanics, quantum information, quantum computation and quantum cryptography, quantum optics, foundations of quantum mechanics, and the quantum-classical correspondence." },
  ...
  { id: "physics.gen-ph", parentId: "physics", name: "General Physics", description: "Foundational, cross-disciplinary and general physics that does not fit a specialized category — classical mechanics, broad physical principles, and general theoretical frameworks." },
  ...
  { id: "physics.pop-ph", parentId: "physics", name: "Popular Physics", description: "Physics written for a general audience: expository and pedagogical articles, science communication, and accessible overviews of physics topics for non-specialists." },
